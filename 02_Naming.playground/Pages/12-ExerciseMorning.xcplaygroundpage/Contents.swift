...
let shower = 9
let getDressed = 2
let makeBreakfast = 10
let eatBreakfast = 15
let readNews = 15
let washDishes = 6
let gettingReady = brushTeeth + shower + getDressed + makeBreakfast + eatBreakfast + readNews + washDishes
...
let haveToDo = brushTeeth + shower + getDressed + makeBreakfast + eatBreakfast
let likeToDo = readNews + washDishes
