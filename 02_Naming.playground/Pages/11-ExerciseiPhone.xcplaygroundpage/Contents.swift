...
*/
let iPhoneStorageCapacity = 8.0
let existingData = 3.0
let availableStorage = iPhoneStorageCapacity - existingData
let dataPerMinuteOfVideo = 0.150
let minutesOfVideoToFilliPhone = availableStorage / dataPerMinuteOfVideo
